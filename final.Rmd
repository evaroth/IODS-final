...
```
Tab.3 & 4: Number of observations and variables for the train and the test set.
```{r dim test train}
...
Tab. 5: Predicted observations and actual observations for the variable lifeexpectancy of the test set crosstabulated
```{r predict with lda}
