...
For taken more variables into account, we can write a multiple regression model with life expectany beeing the dependant variable and several explanatory variables x1, x2, x3 (Mean.Edu, Edu2.FM, Parli.F). 
